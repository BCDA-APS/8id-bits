...
from legacy.id8_i.plans.nexus_acq_eiger_ext import eiger_acq_ext_trig
from legacy.id8_i.plans.nexus_acq_eiger_int import eiger_acq_int_series
from legacy.id8_i.plans.nexus_acq_rigaku_zdt import rigaku_acq_ZDT_series
from legacy.id8_i.plans.nexus_acq_aeon import aeon_acq_series
...
from legacy.id8_i.plans.select_detector import select_detector
